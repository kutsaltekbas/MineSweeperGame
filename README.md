...
- If there is a mine at the point where the user enters, you must lose the game.
...
- If the user can select all the points without pressing any mines, you must win the game.
